...
module.exports = DogeXeonOP = async (DogeXeonOP, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `94759744340@s.whatsapp.net`]
...
scsell = `*BLACK MODZ BOT*\n\n_• 𝒀𝒐𝒖𝑻𝒖𝒃𝒆: https://youtube.com/c/SCMOD_\n_• 𝑊ℎ𝑎𝑡𝑠𝑎𝑝𝑝 𝐺𝑟𝑜𝑢𝑝: https://chat.whatsapp.com/KoNEU2wIMRaFa0H0qvf627_\n\n_「世界是 殘酷的」._`
but = [
...
reply(`${err}`)
	...
	DogeXeonOP.sendMessage(`${owner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Dream Guy Xeon",body:"Dont forget to subscribe Xeon",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/dogepic1.jpg'),sourceUrl:"https://wa.me/94759744340"}}})
        }
	// console.log(e)
	}
}
